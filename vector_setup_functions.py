...
# def create_chroma_db(docs, persist_dir, embed_func):
#     """Take in documents, a location to save the database locally, and the function for embedding and create the vector database"""
#     print("\nCreating vector database...")
#     print("...Will take 10-15 minutes...")

#     # Create Chroma DB and save the reference
#     vectordb = Chroma.from_documents(documents=docs, embedding=embed_func, persist_directory=persist_dir)
